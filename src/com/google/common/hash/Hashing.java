...
public final class Hashing {
  ...
  /**
   * Returns a hash function implementing the <a href="http://code.google.com/p/cityhash/">
   * CityHash</a>-64 algorithm (64 hash bits).
   */
  public static HashFunction cityHash64() {
    return CityHashFunctions.CITY_HASH_64;
  }
  
  /**
   * Returns a hash function implementing the <a href="http://code.google.com/p/cityhash/">
   * CityHash</a>-64 algorithm (64 hash bits) with the specified seed.
   */
  public static HashFunction cityHash64(long seed) {
    return CityHashFunctions.cityHash64Seeded(seed);
  }
  
  /**
   * Returns a hash function implementing the <a href="http://code.google.com/p/cityhash/">
   * CityHash</a>-64 algorithm (64 hash bits) with the specified seeds.
   */
  public static HashFunction cityHash64(long seed0, long seed1) {
    return CityHashFunctions.cityHash64Seeded(seed0, seed1);
  }
  
  /**
   * Returns a hash function implementing the <a href="http://code.google.com/p/cityhash/">
   * CityHash</a>-128 algorithm (128 hash bits).
   */
  public static HashFunction cityHash128() {
    return CityHashFunctions.CITY_HASH_128;
  }
  
  /**
   * Returns a hash function implementing the <a href="http://code.google.com/p/cityhash/">
   * CityHash</a>-128 algorithm (128 hash bits) with the specified seeds.
   */
  public static HashFunction cityHash128(long seed0, long seed1) {
    return CityHashFunctions.cityHash128Seeded(seed0, seed1);
  }
